...
| `calendar/delete_tentative_onboarding.sh` | どこでも | 杉浦さんが入る HAWK オンボーディングの「仮」予定を前日 18:00 JST に削除（毎日 18:00 の Routine が実行）。`--dry-run` で確認可。使い方は `.claude/skills/tentative-onboarding-cleanup/SKILL.md` |
